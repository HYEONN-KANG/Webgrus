...
import { Form, Input, Button, Typography, message, InputNumber, Skeleton, Checkbox } from 'antd';
		...
		return (
			<Formik
				...
				validationSchema={Yup.object().shape({
					...
					capacity: Yup.number().required('Lecture capacity is required'),
					filePath: Yup.string(),
				})}
										...
										<div style={{ display: 'flex', justifyContent: 'space-between' }}>
											...
											{LectureFilePath && (
												<div style={{ display: 'flex', maxHeight: '500px', maxWidth: '700px' }}>
													<img
														src={`http://localhost:3001/${LectureFilePath}`}
