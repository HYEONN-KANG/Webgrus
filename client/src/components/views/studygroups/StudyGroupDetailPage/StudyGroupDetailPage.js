    ...
    axios
      ...
      .then((response) => {
        if (response.data.success) {
          ...
          message.error(
            "Study Group Deletion Error! Please contact the site manager"
          );
          navigate("/studygroups");
        }
      });
      ...
      buttons = (
        <div tyle={{ width: "90%", display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr" }}>
            ...
            <div>
              <Popconfirm
                title="Are you sure？ This operation is irreversible."
                onConfirm={onDelete}
      ...
      <Row gutter={[16, 16]}>
        <Col lg={24} xs={24}>
          <div className="app" style={{ width: "85%", margin: "auto" }}>
            ...
            <img
              style={{ width: "50%" }}
              src={`http://localhost:3001/${StudyGroupDetail.filePath}`}
              controls
            />
            <br />
            <Divider>
            ...
            <Divider />
            <Divider>
              <h2>Manager Conatact Infomation</h2>
            </Divider>
            <br />
